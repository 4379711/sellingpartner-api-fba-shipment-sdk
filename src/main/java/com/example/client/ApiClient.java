...
import com.example.auth.OAuth;
import com.example.singer.AWSSigV4Signer;
import com.example.singer.LWAAuthorizationSigner;
...
public class ApiClient {
    ...
    public ApiClient() {
        ...
        httpClient.setWriteTimeout(180, TimeUnit.SECONDS);
        verifyingSsl = false;
        json = new JSON();
